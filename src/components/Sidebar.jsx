...
export default function Sidebar() {
  ...
  return (
    <aside className="position-fixed top-0 start-0 vh-100 bg-dark text-light d-flex flex-column justify-content-between shadow-lg" style={{ width: "250px", zIndex: 1000 }}>
      {/* Logo */}
      <div className="p-3 text-center border-bottom border-secondary">
        <div className="d-flex justify-content-center align-items-center mb-2">
          <img src="/LogoLautaro.png" alt="Logo" style={{ width: "40px", height: "40px", marginRight: "10px" }} />
      ...
      <nav className="flex-grow-1 overflow-auto px-3 py-3">
        ...
        {/* Administración */}
        <div className="mt-4">
          <button onClick={() => setOpenAdmin(!openAdmin)} className="btn btn-sm w-100 text-start text-light d-flex justify-content-between align-items-center px-0" style={{ background: "none", border: "none" }}>
            <div className="d-flex align-items-center">
              <UserGroupIcon style={{ width: "24px", marginRight: "10px", color: "red" }} /> Administración
            </div>
            <span>{openAdmin ? "▲" : "▼"}</span>
          </button>
      ...
      {/* Cerrar sesión */}
      <div className="p-3">
        <button onClick={() => logout()} className="btn btn-danger w-100 d-flex align-items-center justify-content-center gap-2 fw-semibold">
          <PowerIcon style={{ width: "18px" }} /> Cerrar Sesión
        </button>
      </div>
    </aside>
  );
