...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetchAPI("/api/empleados/login", {
        method: "POST",
        data: { username, contrasena },
      });
      ...
      login({
        ...
        user: data.user,
        rol: data.rol?.rol,
      }, data.token); // <- asegúrate de que el backend devuelva token
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light border-end-0"><i className="bi bi-person-fill text-secondary"></i></span>
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              <span className="input-group-text bg-light border-end-0"><i className="bi bi-key-fill text-secondary"></i></span>
